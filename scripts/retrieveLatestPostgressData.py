...
ds = store.get_data_source("callSource")
job = PostgreSQLOfflineStore.pull_all_from_table_or_query(config=store.config,
    data_source=ds, join_key_columns=['id'], timestamp_field=ds.timestamp_field,
    feature_name_columns=['waitDuration'],
